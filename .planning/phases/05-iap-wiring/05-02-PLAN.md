...
11. **Error handling**: Wrap all processing in try/catch. On error, log with structured logging, return HTTP 200 with `{ error: message }`. This is critical -- returning non-200 triggers RevenueCat retries at 5/10/20/40/80 minute intervals.
